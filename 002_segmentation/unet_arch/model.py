...
class DoubleConv(nn.Module):
    ...
    Each block consists of a 2D convolution, group normalization,
    ...
    def __init__(
        ...
        num_groups : int, default=8
            Number of channel groups used by GroupNorm.
        """
...
class UNET(nn.Module):
    ...
    def __init__(
        ...
        num_groups : int, default=8
            Number of channel groups used by every GroupNorm layer.
        """
        ...
        for feature in features:
            self.downs.append(DoubleConv(in_channels, feature, num_groups))
            in_channels = feature
        ...
        for feature in reversed(features):
            ...
            self.ups.append(DoubleConv(feature * 2, feature, num_groups))

        # Bottleneck
        self.bottleneck = DoubleConv(features[-1], features[-1] * 2, num_groups)
