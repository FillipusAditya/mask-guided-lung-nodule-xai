...
from config import (
    COMBINED_HOLDOUT_CSV as INPUT_METADATA_CSV,
    CV_METADATA_CSV as OUTPUT_METADATA_CSV,
    CV_SUMMARY_CSV as OUTPUT_SUMMARY_CSV,
    N_SPLITS,
    RANDOM_SEED,
    SHUFFLE,
)
...
def print_summary(
    ...
    output_csv: str | Path = OUTPUT_METADATA_CSV,
    summary_csv: str | Path = OUTPUT_SUMMARY_CSV,
    n_splits: int = N_SPLITS,
    random_seed: int = RANDOM_SEED,
) -> None:
    ...
    print("=" * 88)
    print(f"Input metadata     : {input_csv}")
...
def create_classification_folds(
    input_csv: str | Path = INPUT_METADATA_CSV,
    output_csv: str | Path = OUTPUT_METADATA_CSV,
    summary_csv: str | Path = OUTPUT_SUMMARY_CSV,
    n_splits: int = N_SPLITS,
    ...
    """Generate, validate, save, and return classification fold metadata."""
